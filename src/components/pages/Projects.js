...
function Projects() {
    ...
    return (
        <>
            ...
            <ProjectItem title='Coaching Manager' text='An appointment scheduling application that utilizes RESTful conventions and authentication. Athletes are able to schedule 30 minute training sessions with coaches in database during a specific hours of operation. These sessions are have CRUD functionality and can be changed or canceled after scheduling.' label='Ruby on Rails' github='' demo='' />
            <ProjectItem title='PokeTeams' text='Social website with authentication programmed using Ruby. Pokemon fans are able to share their favorite Pokemon teams with an online community.' label='Ruby' github='' demo='' />
            <ProjectItem title='Gaming News CLI' text='My very first project that I have ever created. This command line interface scrapes data from PC Gamer and allows you to read 10 latest PC Gamer news articles (updated in realtime).' label='Ruby' github='' demo='' />
        </>
    )
}
